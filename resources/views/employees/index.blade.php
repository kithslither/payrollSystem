                    ...
                    <div class="col-lg-12">
                        ...
                        <!-- START TABS -->
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="{{ action("EmployeesController@create") }} ">Add Employee</a></li>
                                ...
                                <div class="tab-content">
						                    ...
						                    <div class="col-lg-3">
						                        <div class="panel panel-default">
						                            ...
						                            <div class="panel-body">
						                                ...
						                                <h4>{{ $employees->fname }}</h4><p><h5>{{ $employees->lname }}</h5>
						                                <p>{{ $employees->emp_id }}</p>
						                                <p>School Nurse</p>
						                                <p>
						                                
						                                <a href="{{ url ('/employees', $employees->id)}}" class="btn btn-primary">Details</a>
                                                        <a href="{{ action("EmployeesController@edit", $employees->id ) }} " class="btn btn-primary">update</a>
                                    ...
                                    <!--
                                        <p>Vestibulum nec erat eu nulla rhoncus fringilla ut non neque. Vivamus nibh urna, ornare id gravida ut, mollis a magna. Aliquam porttitor condimentum nisi, eu viverra ipsum porta ut. Nam hendrerit bibendum turpis, sed molestie mi fermentum id. Aenean <var></var>olutpat velit sem. Sed consequat ante in rutrum convallis. Nunc facilisis leo at faucibus adipiscing.</p> -->
